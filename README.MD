# angular-hotkeys
Angular 6.0 compatible
Cloned from https://github.com/brtnshrdr/angular2-hotkeys
...
```bash
$ npm install @ucosty/angular-hotkeys --save
```
...
```typescript
import {HotkeyModule} from '@ucosty/angular-hotkeys';
```
